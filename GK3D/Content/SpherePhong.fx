...
{   
	...
	float4 diffuse = DiffuseColor * DiffuseIntensity * lightIntensity;
    ...
    return saturate(input.Color + max(AmbientColor * AmbientIntensity,0)+ max(diffuse, 0) + max(0,specular));
}
